-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STORE_OWNER', 'CUSTOMER');
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "stores"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
